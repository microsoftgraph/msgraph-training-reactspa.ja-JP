# <a name="how-to-run-the-completed-project"></a><span data-ttu-id="8f939-101">完了したプロジェクトを実行する方法</span><span class="sxs-lookup"><span data-stu-id="8f939-101">How to run the completed project</span></span>
